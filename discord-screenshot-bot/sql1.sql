...
,avg(cnt_driver_7) as cnt_driver_7
,avg(cnt_driver_8) as cnt_driver_8
...
,avg(cnt_driver_7_1) as cnt_driver_7_1
,avg(cnt_driver_8_1) as cnt_driver_8_1
...
,avg(cnt_driver_7_2) as cnt_driver_7_2
,avg(cnt_driver_8_2) as cnt_driver_8_2
...
,count(distinct (case when p5_bcpm_driver>1.5 and p5_bcpm_driver<=1.6 then driver_id end)) as cnt_driver_3
,count(distinct (case when p5_bcpm_driver>1.6 and p5_bcpm_driver<=1.7 then driver_id end)) as cnt_driver_4
,count(distinct (case when p5_bcpm_driver>1.7 and p5_bcpm_driver<=1.8 then driver_id end)) as cnt_driver_5
,count(distinct (case when p5_bcpm_driver>1.8 and p5_bcpm_driver<=2.1 then driver_id end)) as cnt_driver_6
,count(distinct (case when p5_bcpm_driver>2.1 and p5_bcpm_driver<=2.4 then driver_id end)) as cnt_driver_7
,count(distinct (case when p5_bcpm_driver>2.4 then driver_id end)) as cnt_driver_8
...
,count(distinct (case when p10_bcpm_driver>1.5 and p10_bcpm_driver<=1.6 then driver_id end)) as cnt_driver_3_1
,count(distinct (case when p10_bcpm_driver>1.6 and p10_bcpm_driver<=1.7 then driver_id end)) as cnt_driver_4_1
,count(distinct (case when p10_bcpm_driver>1.7 and p10_bcpm_driver<=1.8 then driver_id end)) as cnt_driver_5_1
,count(distinct (case when p10_bcpm_driver>1.8 and p10_bcpm_driver<=2.1 then driver_id end)) as cnt_driver_6_1
,count(distinct (case when p10_bcpm_driver>2.1 and p10_bcpm_driver<=2.4 then driver_id end)) as cnt_driver_7_1
,count(distinct (case when p10_bcpm_driver>2.4 then driver_id end)) as cnt_driver_8_1
...
,count(distinct (case when b_cpm_avg_driver>1.5 and b_cpm_avg_driver<=1.6 then driver_id end)) as cnt_driver_3_2
,count(distinct (case when b_cpm_avg_driver>1.6 and b_cpm_avg_driver<=1.7 then driver_id end)) as cnt_driver_4_2
,count(distinct (case when b_cpm_avg_driver>1.7 and b_cpm_avg_driver<=1.8 then driver_id end)) as cnt_driver_5_2
,count(distinct (case when b_cpm_avg_driver>1.8 and b_cpm_avg_driver<=2.1 then driver_id end)) as cnt_driver_6_2
,count(distinct (case when b_cpm_avg_driver>2.1 and b_cpm_avg_driver<=2.4 then driver_id end)) as cnt_driver_7_2
,count(distinct (case when b_cpm_avg_driver>2.4 then driver_id end)) as cnt_driver_8_2
